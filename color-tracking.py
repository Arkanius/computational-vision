...
if __name__=='__main__':
    ...
    while True:
        ...
        mask = cv2.inRange(frame, lower, upper) # create the mask - InTange Docs: https://docs.opencv.org/3.4/da/d97/tutorial_threshold_inRange.html
        ...
        for cnts in contours:
            ...
            if w > 25 and h > 25:
                ...
                cv2.imshow('imagem cortada', image)
